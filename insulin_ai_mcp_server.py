...
def resolve_biologic_target(
    ...
    When ``run_dir`` is set (or ``INSULIN_AI_SESSION_DIR`` is active and you omit ``run_dir`` after
    ...
    """
    from insulin_ai.services import biologic_resolver as bio_res
...
def start_biologics_session(
    ...
    Sets ``INSULIN_AI_SESSION_DIR`` and, when resolution succeeds, ``INSULIN_AI_TARGET_PROTEIN_PDB`` so
    ...
    try:
        ...
        if bio.pdb_path and bio.fetch_ok:
            os.environ["INSULIN_AI_TARGET_PROTEIN_PDB"] = bio.pdb_path
        else:
            os.environ.pop("INSULIN_AI_TARGET_PROTEIN_PDB", None)
...
def _persist_retrosynthesis_plan(
    ...
    from insulin_ai.services.biologics_session import patch_world_retrosynthesis, write_retrosynthesis_artifact
...
def plan_retrosynthesis(
    ...
    **Engines:** RetroSynthesisAgent KG tree from session extractions; AiZynthFinder enriches
    ...
    Args:
        ...
        biologic_pdb_path: optional PDB path for metadata; defaults to ``INSULIN_AI_TARGET_PROTEIN_PDB`` if set
    """
    ...
    from insulin_ai.services.retrosynthesis_service import plan_retrosynthesis as _plan
...
def check_monomer_admet(
    ...
    Requires: pip install insulin-ai[admet] for ADMET-AI predictions.
...
def compile_results(
    ...
    Args:
        ...
        biologic_pdb_path: optional; defaults to ``INSULIN_AI_TARGET_PROTEIN_PDB`` env if set
    """
    from insulin_ai.retrosynthesis.models import (
        RetrosynthesisConstraints,
        RetrosynthesisRequest,
    ...
    from insulin_ai.services.retrosynthesis_service import plan_retrosynthesis as _plan
    from insulin_ai.services.toxicity_service import screen_monomer
    from insulin_ai.services.results_compiler import compile_results as _compile
...
def get_candidate_profile(
    ...
    try:
        ...
        if session:
            ...
            from insulin_ai.services.pipeline_audit import save_pipeline_stage as _audit
...
def check_excipient_compliance(
    ...
    """
    from insulin_ai.services.compliance_service import check_excipient_compliance as _check
...
def save_funnel_context(
    ...
    Args:
        ...
        run_dir: Session directory. Defaults to active INSULIN_AI_SESSION_DIR.
    """
    from insulin_ai.services.funnel_context import save_funnel_context as _save
...
def get_funnel_context(
    ...
    """
    from insulin_ai.services.funnel_context import get_funnel_context as _get, list_funnel_stages
...
def save_pipeline_stage(
    ...
    Args:
        ...
        run_dir: Session directory.
    """
    from insulin_ai.services.pipeline_audit import save_pipeline_stage as _save
...
def get_pipeline_audit(
    ...
    Args:
        ...
        run_dir: Session directory.
    """
    from insulin_ai.services.pipeline_audit import get_pipeline_audit as _get
