...
class IterativeLiteratureMiner(MaterialsLiteratureMiner):
    ...
    def mine_with_feedback(self, 
        ...
        import os
        from biologix_ai.literature.literature_scholar_only import run_scholar_mine
    ...
    def _extract_with_dynamic_prompts(self, papers: List[Dict], iteration: int,
        ...
        from biologix_ai.literature.literature_scholar_only import seed_candidates_from_papers
            ...
            if material_mutator:
                try:
                    ...
                    raise RuntimeError(
                        ...
                        "install biologix-ai with mutation extras."
                    ) from e
...
# Demo: requires Ollama serve + model pulled; set BIOLOGIX_AI_DEMO=1
if __name__ == "__main__":
    if os.environ.get("BIOLOGIX_AI_DEMO") != "1":
        print("Set BIOLOGIX_AI_DEMO=1 and run Ollama to execute this demo.")
        raise SystemExit(0)
