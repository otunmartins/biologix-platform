...
Env BIOLOGIX_AI_SESSION_DIR: absolute path to active session (set by CLI/subprocess).
"""
...
ENV_SESSION = "BIOLOGIX_AI_SESSION_DIR"


def repo_root_from_package() -> Path:
    """src/python/biologix_ai/run_paths.py -> biologix-ai repo root."""
