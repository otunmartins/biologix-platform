...
def create_experiment(req: StartExperimentRequest):
    from insulin_ai.services.biologic_resolver import resolve_biologic_target
...
def get_audit(experiment_id: str, candidate_psmiles: Optional[str] = None):
    session = _session_path(experiment_id)
    from insulin_ai.services.pipeline_audit import get_pipeline_audit
...
def get_funnel_stages(experiment_id: str):
    session = _session_path(experiment_id)
    from insulin_ai.services.funnel_context import list_funnel_stages
...
def get_funnel_checkpoint(experiment_id: str, stage: str):
    session = _session_path(experiment_id)
    from insulin_ai.services.funnel_context import get_funnel_context
