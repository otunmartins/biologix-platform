...
def run_biologics_discovery_loop(
    ...
    from insulin_ai.retrosynthesis.models import RetrosynthesisConstraints, RetrosynthesisRequest
    from insulin_ai.services.biologics_session import write_retrosynthesis_artifact
    from insulin_ai.services.retrosynthesis_service import plan_retrosynthesis as plan_retro_svc
    from insulin_ai.services.results_compiler import compile_results as compile_svc
    ...
    if (polymer_target or "").strip():
        ...
        from insulin_ai.services.designer_service import generate_candidates
    ...
    if run_openmm and candidates:
        try:
            ...
            _os_max = os.environ.get("INSULIN_AI_OPENMM_MAX_MINIMIZE_STEPS", "")
            if not _os_max:
                os.environ["INSULIN_AI_OPENMM_MAX_MINIMIZE_STEPS"] = "2000"
            sim = MDSimulator()
            tgt = candidates[0]
