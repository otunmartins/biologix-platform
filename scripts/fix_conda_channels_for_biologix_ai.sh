...
# Run from repo root:  bash scripts/fix_conda_channels_for_biologix_ai.sh
#
...
echo "Next — pick one:"
echo "  A) Default (chunked conda + pip):  ./install   or   bash \"$REPO/scripts/install_biologix_ai_sim_lowmem.sh\""
